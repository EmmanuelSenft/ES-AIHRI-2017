...
%As robots will integrate human society, they will have to satify humans'
    %expectations. However at the design time, it seems hardly possible to know
    %in advance exactly all the behaviours expected from the robot. As such to
    %be accepted in human society robots have to learn how to interact with
    %humans.
...
%Classic approaches in RL generally rely on exploring virtual environments where
%the agent tries to maximise the reward.
